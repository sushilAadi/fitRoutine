      ...
      (t) => (
        <div className="">
          ...
          <div className="flex justify-between mt-2">
            <button
              className="px-2 py-1 w-[50%]  border-none bg-red-500"
              onClick={() => {
                toast.dismiss(t.id);
                moveToNextDay(true);
              }}
            ...
            <button
              className="px-2 py-1 w-[50%]  border-none bg-tprimary"
              onClick={() => {
                toast.dismiss(t.id);
              }}
            >
  ...
  return (
    <>
      <div className="flex flex-col h-screen overflow-hidden text-black ">
        <div className="top-0 p-3 pb-1 text-white bg-black sticky-top">
            ...
            {workoutData?.workoutPlan?.[selectedWeek]?.[
              ...
              return (
                <SwiperSlide key={exerciseIndex}>
                  <div className={`my-3  text-black rounded-xl`}>
                    <ExerciseHeader
                      selectedWeek={selectedWeek}
                      selectedDay={selectedDay}
                      setSelectedExercise={setSelectedExercise}
                      addExerciseDetails={addExerciseDetails}
                      exercise={exercise}
                              ...
                              {exercise.equipment !== "body weight" &&
                                exercise.equipment !== "band" && (
                                  <input
                                    type="number"
                                    placeholder="weight"
                                    className="px-3 py-2 border outline-none rounded-xl w-100"
                                    disabled={
                                ...
                                {!detail.isCompleted ? (
                                  <>
                                    {isSetEnabled && toggleCheck && (
                                      <i
                                        className={` cursor-pointer  p-2 px-3 fa-solid fa-check text-[20px] bg-[#61616154] rounded-lg`}
                                        onClick={() => {
                                          saveExerciseSet(
                                            selectedWeek,
                                            selectedDay,
                                  ...
                                  <i
                                    className="p-2 px-3   cursor-pointer fa-solid fa-pencil text-[20px] bg-[#61616154] rounded-lg"
                                    onClick={() => {
                                      editExerciseSet(
                                        selectedWeek,
                                        selectedDay,
                          ...
                          >
                            ...
                            {detail.isCompleted && (
                              <>
                                ...
                                <p className="pr-3 text-xs text-gray-800 whitespace-nowrap">
                                  {formatSetTimer(
                                    workoutData?.exerciseHistory[
                                      `${selectedWeek}-${selectedDay}-${exerciseIndex}`
                              ...
                              <>
                                {workoutData?.exerciseHistory[
                                  ...
                                  <>
                                    {" "}
                                    <p>
                                      <i className="pr-2 font-semibold fa-solid fa-person-seat"></i>
                                    </p>
                                    <p className="pr-3 text-xs text-gray-800 whitespace-nowrap">
                                      {formatTime(
                                        workoutData.exerciseHistory[
                            ...
                            {detail.isCompleted && (
                              <>
                                <p>
                                  <i className="pr-2 font-semibold fa-duotone fa-solid fa-weight-hanging whitespace-nowrap"></i>
                                </p>
                    ...
                    {isTimerRunning &&
                      activeExerciseSet?.exercise === exerciseIndex && (
                        <div className="flex items-center justify-center gap-x-4">
                          <button
                            onClick={stopTimer}
                            className="px-3 py-2 mt-3 text-sm font-semibold bg-red-500 rounded-full w-100"
                            disabled={!EditToggle}
                          >
                  ...
                  {isAllExercisesInDayCompleted() &&
                    (selectedDay < workoutData.daysPerWeek - 1 ||
                      ...
                      <button
                        ...
                        className="float-right px-6 py-2 mt-4 mb-2 bg-black rounded-lg"
                      >
                        Complete Workout
                      </button>
                    )}
