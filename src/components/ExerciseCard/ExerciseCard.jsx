            ...
            <div className='bodyWrapper mt-3'>
                ...
                <div className='flex overflow-auto no-scrollbar gap-3 flex-wrap justify-between '>
                    {sortedExercises.map(i => {
                        ...
                        return (
                            <div key={i.id} className="min-w-[45%] max-w-[45%] cursor-pointer rounded-md overflow-hidden h-[260px] relative imgFilter" style={{ backgroundImage: `url(${image})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', boxShadow: 'inset -3px -6px 6px 5px #dcdcdc' }}>
